...
function BestPick() {
	...
	function MultiPage() {
		switch (view) {
			case 0:
				return <TennisBagBox />;
			case 1:
				return <TennisItemBox />;
			case 2:
				return <TennisRacquetBox />;
			case 3:
				return <TennisWomanBox />;
			case 4:
				return <TennisManBox />;
			case 5:
				return <TennisAccBox />;
			case 6:
				return <TennisShoesBox />;
			default:
				return null;
		}
	}
	...
	return (
		...
		>
			...
			{/* 멀티페이지 */}
			<div className="Container bestContentsBox">{MultiPage()}</div>
		</div>
	);
}
